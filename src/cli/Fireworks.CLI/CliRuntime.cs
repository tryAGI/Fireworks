...
internal static class CliRuntime
{
    ...
    public static async Task<global::Fireworks.FireworksClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Fireworks.ApiException exception)
    {
        var builder = new StringBuilder();
