...
namespace Fireworks.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Fireworks.CLI";
    private const string UserSecretApiKeyName = "FIREWORKS_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"FIREWORKS_API_KEY"];
    private const string CredentialFileDirectoryName = ".fireworks";

    public static async global::System.Threading.Tasks.Task<global::Fireworks.FireworksClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Fireworks.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Fireworks.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::Fireworks.FireworksClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Fireworks.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Fireworks.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Fireworks.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Fireworks.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("FIREWORKS_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Fireworks.ApiException exception)
    {
        var builder = new StringBuilder();
