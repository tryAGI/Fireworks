...
{
    /// <inheritdoc />
    public sealed class AudioModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Fireworks.AudioModel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::Fireworks.AudioModelExtensions.ToValueString(value));
        }
    }
}
